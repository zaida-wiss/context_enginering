...
REQUIRED_ACTIVE_PATTERNS = {
    ...
    "SYSTEM_CONTRACT.yaml": (
        ...
        "SEMANTIC PRESERVATION HIERARCHY",
        "Presentation behavior is governed by explicit ownership and semantic hierarchy rather than duplicated prohibitions.",
        "remove or consolidate level-5 duplication first",
        "preserve every required field from levels 1–4 according to its owning authority",
    ),
