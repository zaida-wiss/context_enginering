---
name: cto_feed_forward
description: CTO Feed Forward assignment — team risk analysis video, impacts presentation structure and priorities
metadata:
  type: project
  deadline: 2026-09-24T16:00:00
---

# 🎥 CTO FEED FORWARD — Kursuppgift

**DEADLINE:** Torsdag 24 september kl. 16.00  
**DELIVERABLE:** Inspelad film (max 5 minuter) där teamet presenterar hur riskanalysen påverkat projektet
...
Denna uppgift påverkar flera mötespunkter:

| Slide | Impact |
|-------|--------|
| **⑦ Risker** | Konkreter risker med mitigations från CTO-feedback |
| **⑫ Sprintplan** | Realism-check: Är planen realistisk enligt CTO? |
| **⑬ Actions** | Konkreta GitHub-åtgärder utifrån prioriteringar |

**Presentation bör innehålla:** Konkreta exempel på hur risk-arbetet påverkat planering och prioritering denna vecka.
