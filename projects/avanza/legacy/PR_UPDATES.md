> Archived project-specific legacy guidance migrated from `_ai_guides/PR_UPDATES.md` during framework cleanup. Preserve for historical/project context; it is not generic framework authority. Current behavior must resolve through active authorities and `projects/avanza/PROJECT.yaml`.
...
3. ✅ Fallback 2: Kolla Google Sheets: `See SOURCES.yaml: GOOGLE_PROJECT_DATA_SHEET`
