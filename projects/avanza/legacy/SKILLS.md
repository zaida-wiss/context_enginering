> Archived project-specific legacy guidance migrated from `_ai_guides/SKILLS.md` during framework cleanup. Preserve for historical/project context; it is not generic framework authority. Current behavior must resolve through active authorities and `projects/avanza/PROJECT.yaml`.
