...
description: Issue checklist template that implements the canonical Definition of Done
metadata:
  type: template
  status: active
  critical: true
...
Use this checklist when a GitHub issue needs the project's Definition of Done. The canonical requirements are owned by [`../DEFINITION_OF_DONE.md`](../DEFINITION_OF_DONE.md).
